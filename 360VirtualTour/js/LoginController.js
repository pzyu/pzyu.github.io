function checkCreatTourFormAndRedirect() {
    var tourTitle = document.querySelector("#tourTitleField");
	var tourSynopsis = document.querySelector("#synopsisField");
    if (tourTitle == "") {
        console.log("xxx: tourTitle Valid");
	}
	else{
		ShowEditingTourPage();
	}
